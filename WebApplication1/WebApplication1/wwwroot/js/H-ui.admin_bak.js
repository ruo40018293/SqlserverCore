...
$(function(){
	...
	$(document).on("click","#min_title_list li",function(){
		...
		var _href=$("#min_title_list li").eq(bStopIndex).find("span").attr("data-href");
		$(".Hui-aside a").each(function() {
	...
	$(document).on("click","#min_title_list li i",function(){
		...
		num==0?num=0:num--;
		tabNavallwidth();
		var _href=$("#min_title_list li span").eq(aCloseIndex).attr("data-href");
		$(".Hui-aside a").each(function() {
			if($(this).attr("_href")==_href){
				$(".Hui-aside .menu_dropdown li a").removeClass("current");
				$(this).addClass("current");
